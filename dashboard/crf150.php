...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url(images/bg_11.jpg);" data-stellar-background-ratio="0.5">
    				...
    				<div class="row">
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<a  class="img" style="background-image: url(images/menu-25.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<a  class="img" style="background-image: url(images/menu-26.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<a  class="img" style="background-image: url(images/menu-27.jpg);"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<a  class="img" style="background-image: url(images/menu-28.jpg);"></a>
		    				</div>
    					</div>
    				</div>
    			</div>
