        ...
        <div class="row block-9">
          ...
          <div class="col-md-6 ftco-animate">
            <form action="login.php" method="post" class="contact-form">
              ...
              <div class="form-group">
                <input type="submit" value="登入" name="go" class="btn btn-primary py-3 px-5">
                <a href="register.php"><input type="button" value="註冊" class="btn btn-primary py-3 px-5"></a>
              </div>
            </form>
...
if(!$db_link)
{
	...
	if($_POST["account"]!=null && $_POST['go']=="登入")
	{
		...
		echo "<script>alert('登入成功');location.href = 'menu.php'</script>";
		}
		else 
		{
