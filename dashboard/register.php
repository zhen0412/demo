            ...
            <form action="register1.php" method="post" class="contact-form">
            	<div class="row">
	                ...
	                <div class="form-group">
	                  <input type="text" name="na" class="form-control" placeholder="新增名稱">
	                </div>
                </div>
            		<div class="col-md-6">
	                <div class="form-group">
	                  <input type="text" name="acc" class="form-control" placeholder="新增帳號">
	                </div>
                </div>
                <div class="col-md-6">
	                <div class="form-group">
	                  <input type="password" name="pwd" class="form-control" placeholder="設定密碼">
	                </div>
	                </div>
              </div>
              <div class="form-group">
                <input type="date" name="bir" class="form-control" placeholder="生日">
              </div>
              <div class="form-group">
                <input type="text" name="pho" class="form-control" placeholder="電話號碼">
              </div>
              <div class="form-group">
                <input type="submit" value="註冊" class="btn btn-primary py-3 px-5">
                  <input type="reset" value="清除" class="btn btn-primary py-3 px-5">
              </div>
            </form>
          </div>
        </div>
